...
var str = (name, label, opts = {}) => ({
  type: "string",
  name,
  label,
  ...opts
});
var text = (name, label, opts = {}) => ({
  type: "string",
  name,
  label,
...
var singleton = { allowedActions: { create: false, delete: false } };
            ...
            fields: [
              ...
              str("lastUpdated", "Last updated date"),
              {
                ...
                fields: [
                  ...
                  { type: "object", name: "sections", label: "Sections", list: true, ui: { itemProps: (item) => ({ label: item?.heading }) }, fields: [str("heading", "Heading"), text("body", "Body")] }
                ]
              },
              {
                type: "object",
